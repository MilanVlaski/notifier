...
- [ ] Test that EmailValidation works ie:
  - [ ] Throws exception (parameterized)
  - [ ] Passes (parameterized)
- [ ] Test that the exception gets thrown by Notifier, caught and a 400 bad request is returned to client. 
